...
if [ "$uname_S" = "Darwin" ]; then
    PARAMS_DIR="$HOME/Library/Application Support/ReactionParams"
else
    PARAMS_DIR="$HOME/.reaction-params"
fi
...
DOWNLOAD_URL="https://github.com/Raptor3um/reaction/releases/tag/1.2.15.3"
...
Failed to fetch the Reaction parameters!
...
This script will fetch the Reaction SNARK parameters and verify their
...
EOF
    ...
    then
        ...
        cat >> "$README_PATH" <<EOF
This directory stores common Reaction SNARK parameters. Note that it is
