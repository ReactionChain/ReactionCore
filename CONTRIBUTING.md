Contributing to Reaction Core
============================

The Reaction Core project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/Raptor3um/reaction/blob/master/doc/translation_process.md) 
...
The following applies to code changes to the Reaction Core project (and related
projects such as libsecp256k1), and is not to be confused with overall Reaction
Network Protocol consensus changes.

Whether a pull request is merged into Reaction Core rests with the project merge
...
Patches that change Reaction consensus rules are considerably more involved than
...
Where a patch set proposes to change the Reaction consensus, it must have been
...
The review process is normally fairly responsive on the Reaction Core repository, however
...
The project leader is the release manager for each Reaction Core release.
