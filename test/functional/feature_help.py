...
"""Verify that starting reactiond with -h works as expected."""
import subprocess
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start reactiond with -h for help text")
        ...
        self.log.info("Start reactiond with -version for version information")
