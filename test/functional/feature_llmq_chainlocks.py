...
from test_framework.test_framework import ReactionTestFramework
...
class LLMQChainLocksTest(ReactionTestFramework):
    def set_test_params(self):
        self.set_reaction_test_params(6, 5, fast_dip3_enforcement=True)
