    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    if (helpMode == about)
    {
        ...
        QString header = "Usage:\n"
            "  reaction-qt [command-line options]                     \n";
...
All the Reaction in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.001 RTC, 0.01 RTC, 0.1 RTC, 1 RTC and 10 RTC -- sort of like the paper money you use every day.</li> \
