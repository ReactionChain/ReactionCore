...
#ifndef REACTION_ARITH_UINT256_H
#define REACTION_ARITH_UINT256_H
...
public:
     ...
     *
     * Reaction only uses this "compact" format for encoding difficulty
...
#endif // REACTION_ARITH_UINT256_H
