...
#error Client version information missing: version is not defined by reaction-config.h or in any other way
#endif
...
/**
 * reactiond-res.rc includes this file, but it cannot cope with real c++ code.
