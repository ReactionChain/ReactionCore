...
* reaction.conf: contains configuration settings for reactiond or reaction-qt
* reactiond.pid: stores the process id of reactiond while running
* database/*: BDB database environment; only used for wallet
* db.log: wallet database log file
* debug.log: contains debug information and general logging generated by reactiond or reaction-qt
